 ...
 */
final class Version20190821093037 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD role VARCHAR(120) NOT NULL COLLATE utf8mb4_unicode_ci, DROP roles');
    }
}
